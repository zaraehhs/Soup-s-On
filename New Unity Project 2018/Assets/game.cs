...
public class game : MonoBehaviour
{
    ...
    public void setMessage(string message)
    {
     ...
     public void checkifRecipeCompleted() {//Loads the final scene 

        if ( food1Tot == getCount(food1Name) && 
              food2Tot == getCount(food2Name) &&
              food3Tot == getCount(food3Name) &&
              food4Tot == getCount(food4Name) 
             ) {
                 messageText.text = "Recipe Done! You must turn off the stove"; 
    ...
    public void loadFinalScene() {//Loads the final scene 
